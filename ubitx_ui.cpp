...
//x,y, 07_sp7etd
  ...
  {128, 200, 60, 36, "1v1", "Q"}//08_sp7etd - s-meter button used to display sp7etd firmware version,09_sp7etd update @09_sp7etd @1v0 @1v1
};
...
void btnDraw(struct Button *b){
  ...
  else if (!strcmp(b->text, "1v1") && s_meter_on == 1) //08_sp7etd - new line @09_sp7etd @1v0 @1v1
...
void doCommand(struct Button *b){
  ...
  {
    switchBand(3500000l);
    getButton("LSB", &e);//11_sp7etd
    sidebandToggle(&e);//11_sp7etd
  }
  ...
  else if (!strcmp(b->text, "1v1"))//08_sp7etd - detection of s-meter button press and call respective service function @09_sp7etd @1v0 @1v1
