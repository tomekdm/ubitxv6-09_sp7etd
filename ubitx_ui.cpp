...
//x,y, 07_sp7etd
  ...
  {128, 200, 60, 36, "1v0", "Q"}//08_sp7etd - s-meter button used to display sp7etd firmware version,09_sp7etd update @09_sp7etd @1v0
};
...
void btnDraw(struct Button *b){
  ...
  else if (!strcmp(b->text, "1v0") && s_meter_on == 1) //08_sp7etd - new line @09_sp7etd @1v0
...
void doCommand(struct Button *b){
  ...
  else if (!strcmp(b->text, "1v0"))//08_sp7etd - detection of s-meter button press and call respective service function @09_sp7etd @1v0
