...
void checkButton(){
 ...
 active_delay(100);
  ...
  if (downTime >= 40 && downTime < 150) doCommands();//02_sp7etd //@11_sp7etd 100@150
  if (downTime >= 150 && touch==1) touch=0; //04_sp7etd - if button pressed for >5s toggle TFT touch //@11_sp7etd 100@150
      else if (downTime >= 150 && touch==0) touch=1;//04_sp7etd - if button pressed for >5s toggle TFT touch //@11_sp7etd 100@150
...
// the screen calibration parameters : int slope_x=104, slope_y=137, offset_x=28, offset_y=29;
  ...
  if (usbCarrier > 11060000l || usbCarrier < 11048000l)
    {
      usbCarrier = 11056500l;// 10_sp7etd - changing default when BFO not calibrated (previous 11053000l;)
  ...
  if (cwDelayTime < 10 || cwDelayTime > 100)
    cwDelayTime = 50;
  if (calibration < -2000000l || calibration > 2000000l) //10_sp7etd if master offset for frequency calibration is less or grater than 2 millions (not calibrated), then set to calibration to 0
    {
      calibration = 0;
